...
class _SettingsState extends State<Settings> {
                            ...
                            children: <Widget>[
                              ...
                              Column(
                                ...
                                children: <Widget>[
                                  ...
                                  SizedBox(height: 10),
                                  Text("Developed by Kartik Saxena,",
                                      style: TextStyle(
                                  ...
                                  RichText(
                                      text: new TextSpan(children: [
                                        new TextSpan(
                                          text: '  Devansh Dwivedee and Ayuja Srivastava',
                                          style: new TextStyle(
  ...
  void openLink() async {
    String url = 'https://www.google.com/webhp?hl=en&sa=X&ved=0ahUKEwigvNWEz8juAhVTIbcAHXQuAUoQPAgI';
    if (kIsWeb) {
