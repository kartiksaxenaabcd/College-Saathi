          ...
          children: <Widget>[
            Row(
              ...
              children: <Widget>[
                Container(
                    height: 375,
                    child: Image.asset("assets/backgrounds/clipart1599036.png")),
              ],
            ),
            Column(
              children: <Widget>[
                ...
                Text(
                  "Boost your productivity by organizing and planning all your college activities in one place !",
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 20,
            ...
            child: Column(
              ...
              children: <Widget>[
                (scrn_height < 750)
                    ...
                    child: Image.asset(
                        "assets/backgrounds/clipart1599036.png"))
                    : Image.asset("assets/backgrounds/clipart1599036.png"),
                Container(
